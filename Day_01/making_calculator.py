...
# very basic calculators for doing computations of two numbers
...
print("The value of floor division is:",a//b)
...
# Division (/): Returns a floating-point result (with decimal values).
